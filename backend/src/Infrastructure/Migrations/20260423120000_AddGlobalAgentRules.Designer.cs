...
namespace DevPilot.Infrastructure.Migrations
{
    ...
    [Migration("20260423120000_AddGlobalAgentRules")]
    partial class AddGlobalAgentRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.CodeAnalysis", b =>
                {
                    ...
                    b.HasIndex("RepositoryId", "Branch")
                        .IsUnique();
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.FileAnalysis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("KeyFunctions")
                        .HasColumnType("text")
                        .HasColumnName("key_functions");
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.GlobalAgentRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.LlmSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("llm_settings", (string)null);
                });

            modelBuilder.Entity("DevPilot.Domain.Entities.McpServerConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.Repository", b =>
                {
                    ...
                    b.Property<string>("AgentRules")
                        .HasColumnType("text")
                        .HasColumnName("agent_rules");

                    b.Property<string>("AzureIdentityClientId")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("azure_identity_client_id");

                    b.Property<string>("AzureIdentityClientSecret")
                        .HasColumnType("text")
                        .HasColumnName("azure_identity_client_secret");

                    b.Property<string>("AzureIdentityTenantId")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("azure_identity_tenant_id");
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.StorySandboxConversationSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserStoryId", "SandboxId")
                        .IsUnique();

                    b.ToTable("story_sandbox_conversation_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid?>("PreferredSharedLlmSettingId")
                        .HasColumnType("uuid")
                        .HasColumnName("preferred_shared_llm_setting_id");
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.UserRepositorySandboxBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.StorySandboxConversationSnapshot", b =>
                {
                    b.HasOne("DevPilot.Domain.Entities.UserStory", null)
                        .WithMany()
